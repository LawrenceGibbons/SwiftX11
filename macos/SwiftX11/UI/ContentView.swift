    ...
    VStack(alignment: .leading, spacing: 12) {
      ...
      HStack {
        ...
        Toggle("XKEYBOARD", isOn: $settings.xkbAdvertised)
          .toggleStyle(.switch)
          .help("Advertise the XKEYBOARD extension. Clients then fetch the keymap with XkbGetMap instead of the core GetKeyboardMapping. Required for GTK3 dialogs to accept typed input while XInput2 is on. Restart X11 clients after changing.")
