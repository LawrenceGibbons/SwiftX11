...
3. **XKEYBOARD verification (Phase F, v1.20.0.20)** — run the checklist in `docs/XI2_XORG_COMPARISON.md` §6 Phase F with the XKEYBOARD toggle on (xkbcomp/xmodmap/xev from `/opt/X11/bin`, then xterm, Vivado, Vitis, portal-GTK over XI2); once green, flip XKEYBOARD and XInput2 to default ON
