...
public:
  ...
  bool pushCreate(uint32_t xid, uint32_t parent, const char* title,
                  int32_t x, int32_t y, int32_t w, int32_t h, uint32_t flags = 0) {
    return push(UICommand{UICommand::Type::Create, xid, parent, x, y, w, h, flags, 0, 0, title});
  }
  // ...others similarly...
