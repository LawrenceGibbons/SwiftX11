...
// X11 SelectInput / event-mask bits live in Core/XEventMask.hpp (one
// definition of x11::mask — this header used to carry a duplicate, which
// broke any TU including both).
